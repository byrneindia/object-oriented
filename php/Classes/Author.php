<?php
namespace byrneindia\DataDesign;
...
class Author {
	...
	public function setAuthorActivationToken(string, $newAuthorActivationToken):string{
	 ...
	 **/
			...
			public function setAuthorHash(string $newAuthorHash = null) : string {
				//enforce has format.
